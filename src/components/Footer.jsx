...
/>
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/jayeetrab"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/jayhighlens/"><i className="ri-instagram-fill ri-2x"></i></a>
        </div>
